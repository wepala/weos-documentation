...
### Create a basic edit endpoint with the identifier in the header with an alias
...
### Create a basic edit endpoint with the identifier in the path and the controller manually set
